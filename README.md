...
- [TanStack Router](docs/tanstack-router.md), [Error Boundaries](docs/error-boundaries.md), [Auth Routing](docs/auth-routing.md), [Auth Session Contract](docs/auth-session-contract.md), [Secure Storage](docs/secure-storage.md), [Config Boundaries](docs/config.md), [TanStack Query](docs/tanstack-query.md), and [UI Foundation](docs/ui-foundation.md) for renderer app architecture.
